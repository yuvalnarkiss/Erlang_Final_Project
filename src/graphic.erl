...
%%%===================================================================
  ...
  %Graphics
  WxServer = wx:new(),
  Frame = wxFrame:new(WxServer, ?wxID_ANY, "MAP", [{pos, ?wxDefaultPosition},{size, ?wxDefaultSize}]),
  {SC_X,SC_Y} = {?STATIONARY_COMP_X,?STATIONARY_COMP_Y},
  Panel  = wxPanel:new(Frame,[{size, {?MAP_WIDTH, ?MAP_HEIGHT}}]),
  Panel2  = wxPanel:new(Frame, [{size, {?STATISITC_WIDTH,?SCREEN_HEIGHT}}]),
  wxPanel:setBackgroundColour(Panel2, {169, 169, 169}),

  %Statistics box-------------------------------------------------------------------
  MainSizer = wxBoxSizer:new(?wxHORIZONTAL),
  Font = wxFont:new(12,?wxDECORATIVE,?wxFONTSTYLE_NORMAL,?wxFONTWEIGHT_LIGHT,[]),

  Title1 = wxStaticText:new(Panel2, ?wxID_ANY, "Main Statistics", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Title1, Font),

  Title2 = wxStaticText:new(Panel2, ?wxID_ANY, "Upper Left Quarter Statistics", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Title2, Font),

  Title3 = wxStaticText:new(Panel2, ?wxID_ANY, "Upper Right Quarter Statistics", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Title3, Font),

  Title4 = wxStaticText:new(Panel2, ?wxID_ANY, "Lower Left Quarter Statistics", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Title4, Font),

  Title5 = wxStaticText:new(Panel2, ?wxID_ANY, "Lower Right Quarter Statistics", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Title5, Font),

  Title6 = wxStaticText:new(Panel2, ?wxID_ANY, "Sensor Condition", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Title6, Font),

  AVG_Temp1 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp2 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp3 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp4 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp5 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),

  wxTextCtrl:setFont(AVG_Temp1, Font),
  wxTextCtrl:setFont(AVG_Temp2, Font),
  wxTextCtrl:setFont(AVG_Temp3, Font),
  wxTextCtrl:setFont(AVG_Temp4, Font),
  wxTextCtrl:setFont(AVG_Temp5, Font),
  AVG_Temp_TXT1 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Temp_TXT1, Font),
  wxTextCtrl:setEditable(AVG_Temp_TXT1, false),
  AVG_Temp_TXT2 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Temp_TXT2, Font),
  wxTextCtrl:setEditable(AVG_Temp_TXT2, false),
  AVG_Temp_TXT3 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Temp_TXT3, Font),
  wxTextCtrl:setEditable(AVG_Temp_TXT3, false),
  AVG_Temp_TXT4 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Temp_TXT4, Font),
  wxTextCtrl:setEditable(AVG_Temp_TXT4, false),
  AVG_Temp_TXT5 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Temp_TXT5, Font),
  wxTextCtrl:setEditable(AVG_Temp_TXT5, false),

  AVG_Hum1 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum2 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum3 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum4 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum5 = wxStaticText:new(Panel2, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),

  wxTextCtrl:setFont(AVG_Hum1, Font),
  wxTextCtrl:setFont(AVG_Hum2, Font),
  wxTextCtrl:setFont(AVG_Hum3, Font),
  wxTextCtrl:setFont(AVG_Hum4, Font),
  wxTextCtrl:setFont(AVG_Hum5, Font),
  AVG_Hum_TXT1 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Hum_TXT1, Font),
  wxTextCtrl:setEditable(AVG_Hum_TXT1, false),
  AVG_Hum_TXT2 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Hum_TXT2, Font),
  wxTextCtrl:setEditable(AVG_Hum_TXT2, false),
  AVG_Hum_TXT3 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Hum_TXT3, Font),
  wxTextCtrl:setEditable(AVG_Hum_TXT3, false),
  AVG_Hum_TXT4 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Hum_TXT4, Font),
  wxTextCtrl:setEditable(AVG_Hum_TXT4, false),
  AVG_Hum_TXT5 = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_Hum_TXT5, Font),
  wxTextCtrl:setEditable(AVG_Hum_TXT5, false),


  Sens_Temp = wxStaticText:new(Panel2, ?wxID_ANY, "Average Sensor's Temp:", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Sens_Temp, Font),
  Sens_Temp_TXT = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(Sens_Temp_TXT, Font),
  wxTextCtrl:setEditable(Sens_Temp_TXT, false),

  Btry_lvl = wxStaticText:new(Panel2, ?wxID_ANY, "Average Battery Level:", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Btry_lvl, Font),
  Btry_lvl_TXT = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(Btry_lvl_TXT, Font),
  wxTextCtrl:setEditable(Btry_lvl_TXT, false),

  Btry_SD = wxStaticText:new(Panel2, ?wxID_ANY, "Battery Standard Deviation:", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(Btry_SD, Font),
  Btry_SD_TXT = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(Btry_SD_TXT, Font),
  wxTextCtrl:setEditable(Btry_SD_TXT, false),

  AVG_MSG = wxStaticText:new(Panel2, ?wxID_ANY, "Average No. of messages:", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(AVG_MSG, Font),
  AVG_MSG_TXT = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(AVG_MSG_TXT, Font),
  wxTextCtrl:setEditable(AVG_MSG_TXT, false),

  MSG_SD = wxStaticText:new(Panel2, ?wxID_ANY, "No. of sent messages Standard Deviation:", [{style, ?wxALIGN_CENTER}]),
  wxTextCtrl:setFont(MSG_SD, Font),
  MSG_SD_TXT = wxTextCtrl:new(Panel2, ?wxID_ANY, [{value, "***************"}, {style, ?wxTE_RIGHT}]),
  wxTextCtrl:setFont(MSG_SD_TXT, Font),
  wxTextCtrl:setEditable(MSG_SD_TXT, false),

  LineAVGTemp1 = wxBoxSizer:new(?wxHORIZONTAL),
  wxSizer:add(LineAVGTemp1, AVG_Temp1, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGTemp2, AVG_Temp2, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGTemp3, AVG_Temp3, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGTemp4, AVG_Temp4, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGTemp5, AVG_Temp5, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGHum1, AVG_Hum1, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGHum2, AVG_Hum2, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGHum3, AVG_Hum3, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGHum4, AVG_Hum4, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(LineAVGHum5, AVG_Hum5, [{flag, ?wxALL bor ?wxALIGN_CENTRE}, {border, 5}]),
  ...
  wxSizer:add(MainSizer, Panel, [{proportion,2},{flag, ?wxEXPAND bor ?wxALIGN_LEFT}]),
  wxSizer:add(MainSizer, Panel2, [{proportion,1},{flag, ?wxEXPAND bor ?wxALL}]),



  wxFrame:setSizerAndFit(Frame, MainSizer),
  wxFrame:setSizerAndFit(Panel2, StatisticsSizer),
  wxFrame:show(Frame),
  ...
  CallBackPaint =	fun(#wx{event = #wxPaint{}}, _wxObj)->
    ...
    BackGroundIMG = wxImage:scale(BackGroundIMG0,?MAP_WIDTH,?MAP_HEIGHT),
    BackGround = wxBitmap:new(BackGroundIMG),
    wxImage:destroy(BackGroundIMG0),
    wxImage:destroy(BackGroundIMG),
