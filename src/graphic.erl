...
init([]) ->
  ...
  AVG_Temp1 = wxStaticText:new(Panel, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp2 = wxStaticText:new(Panel, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp3 = wxStaticText:new(Panel, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp4 = wxStaticText:new(Panel, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  AVG_Temp5 = wxStaticText:new(Panel, ?wxID_ANY, "Average Temp:", [{style, ?wxALIGN_CENTER}]),
  ...
  AVG_Hum1 = wxStaticText:new(Panel, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum2 = wxStaticText:new(Panel, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum3 = wxStaticText:new(Panel, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum4 = wxStaticText:new(Panel, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  AVG_Hum5 = wxStaticText:new(Panel, ?wxID_ANY, "Average Humidity:", [{style, ?wxALIGN_CENTER}]),
  ...
  Btry_SD = wxStaticText:new(Panel, ?wxID_ANY, "Battery Standard Deviation:", [{style, ?wxALIGN_CENTER}]),
  ...
  MSG_SD = wxStaticText:new(Panel, ?wxID_ANY, "No. of sent messages Standard Deviation:", [{style, ?wxALIGN_CENTER}]),
